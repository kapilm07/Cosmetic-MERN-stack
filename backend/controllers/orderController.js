  ...
  if (orderItems && orderItems.length === 0) {
    ...
    if (paymentMethod === 'Razorpay') {
      try {
        ...
        // If Razorpay order creation fails, still return the order
...
// @desc    Update order to paid (legacy endpoint - use Razorpay verification instead)
...
const updateOrderToPaid = asyncHandler(async (req, res) => {
  ...
  if (order) {
    ...
    order.paymentResult = {
      ...
      email_address: req.body.email_address || 'razorpay@beautyhub.com',
    };
